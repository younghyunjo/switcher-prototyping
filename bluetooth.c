...
#define DEVICE_NAME                      "SWICHER_PROTPTYPE"                                /**< Name of device. Will be included in the advertising data. */
...
static ble_uuid_t m_adv_uuids[] = {{BLE_UUID_CURRENT_TIME_SERVICE, BLE_UUID_TYPE_BLE},
	{BLE_UUID_REFERENCE_TIME_UPDATE_SERVICE, BLE_UUID_TYPE_BLE},
...
static void ble_evt_dispatch(ble_evt_t * p_ble_evt)
{
	...
	schedule_service_evt_handler(p_ble_evt);
}
